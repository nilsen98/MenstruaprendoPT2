...
export default function QuizModule7({ navigation }) {
  const moduloId = 7;
  ...
  }, [found, placements.length, navigation]);
  ...
  return (
    ...
    >
      <View style={styles.topBar}>
        <Text style={styles.title}>Módulo 7: Importancia del seguimiento del periodo</Text>
