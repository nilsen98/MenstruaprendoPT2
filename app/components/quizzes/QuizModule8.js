...
const VF_OPTIONS = ["Verdadero", "Falso"];

// Preguntas (correctIndex según tus respuestas)
const QUESTIONS = [
  {
    question:
      "Cuando comienzas a menstruar te conviertes en señorita y debes comportarte como una adulta.",
    options: VF_OPTIONS,
    correct: 1, // Falso
  },
  {
    question: "La menstruación es algo sucio y debe ocultarse.",
    options: VF_OPTIONS,
    correct: 1, // Falso
  },
  {
    question:
      "Usar una copa menstrual o tampón hace que dejes de ser virgen.",
    options: VF_OPTIONS,
    correct: 1, // Falso
  },
  {
    question:
      "El dolor muy fuerte durante la menstruación no es normal y debe atenderse.",
    options: VF_OPTIONS,
    correct: 0, // Verdadero
  },
  {
    question:
      "La salud menstrual es un tema que solo les concierne a las mujeres.",
    options: VF_OPTIONS,
    correct: 1, // Falso
  },
];

export default function QuizModule8({ navigation }) {
  const moduloId = 8;
  ...
  return (
    <View style={[styles.root, { paddingTop: Math.max(insets.top, hp("1%")) }]}>
      <View style={styles.topBar}>
        <Text style={styles.title}>Módulo 8: Lo que nunca debes creer de tu periodo </Text>
